...
router.post("/checkout-balance", express.json(), authMiddleware, createRemainingCheckoutSession);
...
router.post("/verify-payment-intent", express.json(), authMiddleware, verifyPaymentIntent);
